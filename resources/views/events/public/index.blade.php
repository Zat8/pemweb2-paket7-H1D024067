                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-3">
                                ...
                                @if($event->registrations()->count() >= $event->quota)
                                    <span class="text-xs text-red-600 font-semibold">⚠️ KUOTA PENUH</span>
                                @endif
                            </div>
                            
                            <a href="{{ route('events.public.show', $event->slug) }}" 
                               class="block mt-4 text-center bg-indigo-600 text-white py-2 rounded-md hover:bg-indigo-700">
                                Detail & Daftar
                            </a>
                        </div>
                    </div>
